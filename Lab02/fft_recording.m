function [data_clipped,f_fft,fund_freq] = fft_recording(time_vec,data_vec,tmin,tmax,Fs,fig_no,sub_no,fig_text,min_peak_dist,min_peak_height,f_max_view)
    ...
    pk_index = find(nf_pks == max_pk);
    fund_freq = nf_locs(pk_index); 
end
